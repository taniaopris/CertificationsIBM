...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/certifications/admin/**").hasRole("admin")
                .antMatchers("/api/certifications/allCetifications").hasAnyRole("admin","user")
                .antMatchers("/api/requests/admin/**").hasRole("admin")
                .antMatchers("/api/requests/user/**").hasRole("user")
